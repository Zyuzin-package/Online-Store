...
alter table if exists public.discount drop constraint if exists FKr4tq0e68q1e2id6odo428vawp;
alter table if exists public.orders drop constraint if exists FK32ql8ubntj5uh44ph9659tiih;
alter table if exists public.orders_details drop constraint if exists FKs0r9x49croribb4j6tah648gt;
alter table if exists public.orders_details drop constraint if exists FKqrd3t5p4n207uchru3wnbxo9g;
alter table if exists public.product_review drop constraint if exists FKlkf2n9dkjx32vcqqmds9v62;
alter table if exists public.product_review drop constraint if exists FKib6mkfaqaj0beph37y4qxmu9x;
alter table if exists public.products_categories drop constraint if exists FKqt6m2o5dly3luqcm00f5t4h2p;
alter table if exists public.products_categories drop constraint if exists FKtj1vdea8qwerbjqie4xldl1el;
...
alter table if exists public.orders_details add constraint FKqrd3t5p4n207uchru3wnbxo9g foreign key (order_details_id) references public.orders;
